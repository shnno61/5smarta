      ...
      <div className="relative w-full">
        <div className="relative w-full" style={{ height: '400px' }}>
          ...
          <div className="absolute inset-0 flex flex-col justify-end items-center bg-black bg-opacity-10 text-white p-4 text-center font-inter">
            <h2 className="text-lg xs:text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold mb-2 group-hover:hidden">{mainText}</h2>
          </div>
          <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-90 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4 text-center font-inter">
            <h2 className="text-lg text-yellow-500 xs:text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold mb-2">{mainText}</h2>
            <p className="text-lg  xs:text-lg sm:text-lg md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl mb-4">{hoverText}</p>
            <Link href={`/${slug}`} passHref>
              <Button
                ...
                variant="btn_solid"
                className="transition-transform duration-300 transform hover:scale-105 px-3 py-1.5 xs:px-3 xs:py-1.5 sm:px-3.5 sm:py-2.5 md:px-4 md:py-2 lg:px-5 lg:py-2.5 xl:px-6 xl:py-3 2xl:px-7 2xl:py-3.5 text-md xs:text-md sm:text-lg md:text-lg lg:text-lg xl:text-base 2xl:text-lg bg-yellow-600 text-white rounded-lg shadow-md hover:bg-yellow-700 font-inter"
              >
                See More
              </Button>
            </Link>
