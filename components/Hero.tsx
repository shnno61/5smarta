...
const Hero = ({ title, description, imageSrc, imageAlt }: HeroProps) => (
  <section className="relative padding-container flex flex-col gap-6 py-10 md:gap-10 lg:py-20 xl:flex-row xl:gap-10 2xl:py-28 3xl:py-32 4xl:py-40 text-white">
    ...
    <div className="relative pt-10 z-10 flex flex-1 flex-col order-1 xl:order-1 xl:w-1/2 items-center xl:items-start">
    ...
    <div className="relative w-full rounded order-2 xl:order-2 xl:w-1/2 hidden xl:block xl:ml-8 2xl:ml-12 3xl:mx-16 4xl:mx-20">
